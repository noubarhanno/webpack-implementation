...
// bannerEl.src = bannerImg;

$("#pricing-plan").on("click", function () {
  // this is how to import the modal component dynamically (give the chunk name, then the component patch, and this will be async function)
  // after resolving the module, then create a function that will be called when the module is loaded
